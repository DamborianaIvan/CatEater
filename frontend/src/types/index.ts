...
export interface Feeder { _id?: string; feederId: string; userId?: string | null; feederName: string; feederLogo?: string; feederAsign?: boolean; feederQuantity?: number; status?: string; motorState?: boolean; portions?: number; lastConnection?: string | null; motorInfo?: MotorInfo; configuration?: FeederConfiguration; }
